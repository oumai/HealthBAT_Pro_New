...
- (void)codeRequest:(NSString *)imageCode {
    ...
    [HTTPTool requestWithURLString:[NSString stringWithFormat:@"/api/Account/SendVerifyCode/%@/2/%@",self.phoneTF.text,imageCode] parameters:nil type:kGET success:^(id responseObject) {
...
{
    [HTTPTool requestWithURLString:[NSString stringWithFormat:@"/api/system/getMessageImage/%@",self.phoneTF.text] parameters:nil type:kGET success:^(id responseObject) {
