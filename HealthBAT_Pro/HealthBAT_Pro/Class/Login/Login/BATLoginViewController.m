...
- (void)codeRequest:(NSString *)imageCode {
    ...
    [HTTPTool requestWithURLString:[NSString stringWithFormat:@"/api/Account/SendVerifyCode/%@/1/%@",self.registerPhoneTF.text,imageCode] parameters:nil type:kGET success:^(id responseObject) {
...
{
    [HTTPTool requestWithURLString:[NSString stringWithFormat:@"/api/system/getMessageImage/%@",self.registerPhoneTF.text] parameters:nil type:kGET success:^(id responseObject) {
